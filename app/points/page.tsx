    ...
    <div className="flex flex-col min-h-screen bg-[var(--bg)]">
      ...
      <main className="flex-1 mx-auto w-full max-w-4xl px-4 py-8 sm:px-6">
        ...
        <div className="rounded-2xl border border-amber-200/60 bg-amber-50/60 dark:border-amber-800/40 dark:bg-amber-950/20 p-5 mb-6">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-3">When Toilet Book launches the FLUSH token on-chain, early contributors receive a bonus airdrop based on their review tier.</p>
        ...
        <div className="rounded-2xl bg-gradient-to-r from-violet-600 to-sky-600 p-5 text-white text-center">
          ...
          <p className="text-sm text-white/80 max-w-md mx-auto">FLUSH tokens launch on-chain soon. Every point converts 1:1. Keep contributing — early users win the most.</p>
        </div>
      </main>
    </div>
  )
