...
const toiletRotate = scrollProgress * 720
const toiletY = scrollProgress * 120
...
@keyframes tbFloat { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-10p
@keyframes tbScrollBounce { 0%,100%{transform:translateY(0);opacity:.6} 50%{transfo
`}</style>
{/* Top buttons — logged out only */}
{!isLoggedIn && (
<div style={{
position: "absolute", top: 0, left: 0, right: 0,
display: "flex", gap: 10, padding: "52px 20px 16px",
...
textDecoration: "none", boxShadow: "0 4px 15px rgba(14,165,233,0.35)",
}}>
Create account
</Link>
</div>
...
borderRadius: 20, padding: "4px 14px", fontSize: 12, color: "#38bdf8",
...
{/* Headline */}
<h1 style={{
fontSize: 36, fontWeight: 500, color: "#fff", textAlign: "center",
lineHeight: 1.15, marginBottom: 8, position: "relative", zIndex: 2,
padding: "0 24px", letterSpacing: "-0.5px",
}}>
Find the{" "}
<span style={{
background: "linear-gradient(90deg, #38bdf8, #818cf8, #c084fc)",
WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip:
}}>
best toilet
</span>
<br />near you
</h1>
<p style={{ fontSize: 14, color: "#64748b", textAlign: "center", marginBottom: 32, pa
...
ref={toiletRef}
style={{
fontSize: 100, lineHeight: 1, position: "relative", zIndex: 3,
transform: `scale(${toiletScale}) rotate(${toiletRotate}deg) translateY(${toiletY
...
opacity: Math.max(0, 1 - scrollProgress * 5), zIndex: 2,
}}>
<span style={{ fontSize: 11, color: "#334155", letterSpacing: "0.1em" }}>SCROLL TO
<div style={{ animation: "tbScrollBounce 1.5s ease-in-out infinite" }}>
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#334155" stro
<path d="M12 5v14M5 12l7 7 7-7" />
</svg>
</div>
</div>
</section>
{/* ── Floating "Rate a toilet" button — logged in only ── */}
{isLoggedIn && userId && (
<>
<div style={{
